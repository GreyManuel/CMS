...
<div id="content-container">
  <div id="page-head">
    ...
    <div class="text-center">
      <h3>Welcome to NATIONAL WORSHIP TEAM ADMINISTRATION</strong> Dashboard.</h3>
      ...
      <div class="row mar-top">
        ...
        <div class=" panel-primary panel-colorful col-md-3 col-xs-6">
            <div class="pad-all text-center">
              <span class="text-3x text-thin">{{$total['saxophonist']}}</span>
              <p>Saxophonists</p>
        ...
        <div class=" panel-warning panel-colorful col-md-3 col-xs-6">
            <div class="pad-all text-center">
              <span class="text-3x text-thin">{{$total['leader']}}</span>
              <p>Lead Worshippers</p>
        ...
        <div class=" panel-purple panel-colorful col-md-3 col-xs-6">
            <div class="pad-all text-center">
                <span class="text-3x text-thin">{{$total['violinist']}}</span>
                <p>Violinists</p>
        ...
        <div class=" panel-dark panel-colorful col-md-3 col-xs-6">
            <div class="pad-all text-center">
              <span class="text-3x text-thin">{{$total['keyboardist']}}</span>
              <p>Keyboardists</p>
                        ...
                        <table class="table table-condensed table-trans">
                            <tr>
                                <td class="text-lg" style="width: 40px">
                                  <span class="badge badge-purple" style="background-color: {{$colors[0]}}" >{{$total['male']}}</span></td>
                                <td>Male</td>
                            </tr>
                            <tr>
                                <td class="text-lg">
                                  <span class="badge badge-dark" style="background-color: {{$colors[1]}}" >{{$total['female']}}</span></td>
                                <td>Female</td>
                            </tr>
                            <hr>
                            <tr>
                              <td>
                                <div class="text-sm"><p class="text-5x text-thin text-main mar-no"><span class="badge badge-primary" >{{$total['members']}}</span></p></div>
                              </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-{{$isAdmin ? '4' : '6'}}">
                    ...
                    <select id="show" required style="outline:none;" name="sort" class="selectpicker col-md-12" data-style="btn-primary">
                      <option selected value="false">This Block</option>
                      <option value="true">All Blocks</option>
                    </select>
                  </div>
                  @endif
                  <div class="col-xs-{{$isAdmin ? '4' : '6'}}">
  ...
  <div class="row">
    ...
    foreach ($members as $key => $member) {
      // code...
      if (date('Y', (strtotime($member->dob))) == date('Y') || date('Y', (strtotime($member->wedding_anniversary))) == date('Y')  ) {
    ...
    <div class="col-md-6">
        <div class="panel">
          <div class="panel-heading"> <!--body text-center"-->
              <h3 class="panel-title"><strong>Upcoming Wedding(s) For <?php echo date('Y'); $i = 1; ?></strong> </h3>
            ...
            <div class="panel-body text-center clearfix">
              @if(count($celebs) > 0)
                <div class="table-responsive">
                    <table id="anniversaries" class="table table-vcenter mar-top">
                        ...
                        <tbody>
                          ...
                          @if(date('Y', (strtotime($member->wedding_anniversary))) == date('Y'))
                            <tr>
                                ...
                                <td class="text-center">
                                  @if((int)substr(date('Y'),0,1) <= (int)substr(date('y', strtotime($member->wedding_anniversary)), 0,1))
                                ...
                                <td style="color:red" class="text-center">
                                    <div class="btn-group">
                                      {{date('jS, F', strtotime($member->wedding_anniversary))}}
                                    </div>
                                </td>
                            </tr>
                            <?php $i++; ?>
                ...
                @else
                <p class="text-danger"> No Wedding </p>
                @endif
            </div>
        </div>
    </div>
      ...
      <div class="col-md-6">
          <div class="panel">
            <div class="panel-heading"> <!--body text-center"-->
                <h3 class="panel-title"><strong>Funeral(s) For <?php echo date('F Y'); ?></strong> </h3>
                <!--i class="demo-pli-coin icon-4x"></i-->
            </div>
              <div class="panel-body text-center clearfix">
                @if(count($celebs) > 2)
                  ...
                  @else
                  <p class="text-danger"> No Funeral(s) </p>
                  @endif
              </div>
          </div>
      </div>
      ...
      <div class="col-md-6">
          <div class="panel">
              <div class="panel-heading">
                <h1 class="text-bold text-center ji">Upcoming Events</h1>
              </div>
