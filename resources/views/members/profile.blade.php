...
<?php
$dataPoints = array(
array("label"=> "Absent", "y"=> $attendance->no, 'color' => 'red'),
array("label"=> "Present", "y"=> $attendance->yes, 'color' => 'green'),
);
?>
                ...
                <div class="row row-broken" data-height>
                  <div class="col-sm-12 col-md-4" style="border-right:1pt solid rgba(0, 0, 0, 0.1)">
                    ...
                    <div class="col-md-12">
                      ...
                      <hr>
                      <p class="text-align-right">Altar:    <i class="fa fa-map-marker icon-lg icon-fw"></i>{{$member->address}}</p>
                      ...
                      <p class="pad-ver text-main text-sm text-capitalize text-bold">Department: <span class="pull-right">{{$member->position}}</span></p>
                        ...
                        <div class="panel rounded-top">
                          ...
                          <div class="panel-heading bg-dark">
                            <div id="" class="col-xs-12 text-center" style="padding-top:7px;">
                              <h2 class="text-center text-white"><p style="color:white;" >Support  Analysis </p></h2>
                            </div>
                          </div>
